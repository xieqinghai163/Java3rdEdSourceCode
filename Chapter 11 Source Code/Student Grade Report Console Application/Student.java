...
public class Student extends Person
{
    ...
    public void print(double tuitionRate)
    {
        ...
        System.out.printf("%-12s%-15s%-8s%-6s%n","Course No",
                          "Course Name", "Credits",
                          "Grade");                   //Step 4
        ...
        if (isTuitionPaid)                              //Step 7
           System.out.printf("Midsemester GPA: %.2f%n",
                              getGpa());
        else
        {
    ...
    public void print(PrintWriter outp, double tuitionRate)
    {
        ...
        outp.println("Number of courses enrolled: "
                     + numberOfCourses);            //Step 3
        outp.printf("%-12s%-15s%-8s%-6s%n","Course No",
                    "Course Name", "Credits",
                    "Grade");                        //Step 4
        ...
        if (isTuitionPaid)                          //Step 7
           outp.printf("Midsemester GPA: %.2f%n",
                              getGpa());
        else
        {
            outp.println("*** Grades are being held for "
                          + "not paying the tuition. ***");
            outp.printf("Amount Due: $%.2f%n",
                              billingAmount(tuitionRate));
        }
