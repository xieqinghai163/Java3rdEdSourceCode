//String methods - startsWith, endsWith, toLowerCase,
//                 and regionMatches
...
public class StringMethods
{
  ...
  {
    String sentence = "It is cloudy and warm.";             //Line 1
    String str1 = "warm.";                                  //Line 2
    String str2 = "Programming with Java";                  //Line 3
    String str3 = "cloudy";                                 //Line 4
    ...
    System.out.println("Line 16: "
                + "sentence.regionMatches(6,str3,0,6)?: "
                + sentence.regionMatches(6,str3,0,6));      //Line 16
     System.out.println("Line 17: "
           + "sentence.regionMatches(true,6,\"Cloudy\",0,6)?: "
           + sentence.regionMatches(true,6,"Cloudy",0,6));  //Line 17
